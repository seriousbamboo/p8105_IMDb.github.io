...
## 3． Motivation
Given the scenario of social distancing and temporary closure of movie theaters across the United States, Box-office prediction has never been such a crucial problem in the film industry that profitability is directly associated with strategy made by investors and producers. 

Our main goal is to:

*   use skinny to explore the association between the box-office revenue and  other variables including critical review, genre, budget, and content rating
*   create word cloud, radar map on contributing factors
*   generate linear regression model to predict box-office revenue 

We hope this site would help you retrieve useful information and provide you a thorough understanding on key terms that tied with box office success.
