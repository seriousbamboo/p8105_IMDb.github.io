...
- Manipulate `genres` column
  - input example: "avatar|future|marine|native|paraplegic"
  - For model: separate genres into multiple columns with 0 and 1
    ...
    - test for all the movies, if it has the certain genres, change the corresponding number from 0 to 1
  - For shiny: pivot longer
